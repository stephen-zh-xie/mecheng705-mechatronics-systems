...
% goes through a variety of Ls and checks which one needs the highest L

% center frequencies
fcent = [697;770;852;941;1209;1336;1477;1633];

% initialise storage variable to check filter required
testPass = zeros(8, 160); % note: values 1-39 probably unused
testStop = zeros(8, 160);
